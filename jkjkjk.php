...
<div  class="col-md-8" style="margin-top:7%;float:left;margin-left:3%;" >
      <div class="jumbotron"  id="works" style="background-color:#000;height:auto;margin-top:5%;width:74%;"  >
      
      <div  style="padding:5%;" align="left">
      
      
        <p style="color:white;font-family:'Source Sans Pro', sans-serif;font-size:33px;font-weight:bold;margin-top:1%;">Welcome to Reusing Dublin, a space<br><br>  to discover and share information about <br><br> vacant or underused spaces in Dublin</p><br>
        <p  style="color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:600;">Join us in unlocking the potential of the <br><br>spaces in our city</p>
      </div>
      </div>
      </div>
       </div>
  ...
  <div class="row">    <!-- Main component for a primary marketing message or call to action -->
<div  class="col-md-8" style="margin-top:3%;float:left;margin-left:3%;" >
      <div class="jumbotron"  id="works" style="background-color:#FFF;height:auto;margin-top:5%;width:74%;" >
      
      <div style="padding:5%">
        <p style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:35px;font-weight:bold;">How it works</p>
        ...
        <p style="background-color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:28px; padding:10px" >Add a space by clicking the 'add a site' tab and <br/> clicking on the location on the map.</p><br/>
                <p style="background-color:#cadd70;font-family:'Source Sans Pro', sans-serif;font-size:28px;padding:10px"><span style="font-weight:800">Share your information</span> about a site.   </p><br/>
            <p style="background-color:#9dd7e3;font-family:'Source Sans Pro', sans-serif;font-size:28px;padding:10px;"><b>Connect with others</b> who might be interested <br/> in the site.   </p>
      </div>
      </div>
      </div>
      </div>
