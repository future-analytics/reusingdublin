...
$ans1 = htmlentities(mysqli_real_escape_string($con, $_POST['address1']));
//$ans1 = str_replace( $remove, "", $ans1 );
$ans2 = htmlentities(mysqli_real_escape_string($con, $_POST['address2']));
//$ans2 = str_replace( $remove, "",$ans2 );
$ans3 = htmlentities(mysqli_real_escape_string($con, $_POST['address3']));
//$ans3 = str_replace( $remove, "",$ans3 );
$ans4 = htmlentities(mysqli_real_escape_string($con, $_POST['address4']));
//$ans4 = str_replace( $remove, "", $ans4 );
$ans5 =htmlentities(mysqli_real_escape_string($con, $_POST['address5']));
//$ans5  = str_replace( $remove, "", $ans5  );
$ans6 =htmlentities(mysqli_real_escape_string($con, $_POST['address6']));
//$ans6 = str_replace( $remove, "", $ans6 );
$ans7 = htmlentities(mysqli_real_escape_string($con, $_POST['comments']));
...
if((!empty($num_rows)))
{
	$sql4=("UPDATE  SiteDetails SET latitude = '{$_POST['lat1']}', longitude ='{$_POST['lon1']}', adress = '$address',owner = '$ans1',zoning ='$ans2',planningistory = '$ans3' , size = '$ans4',derelict= '$ans5' ,heritage = '$ans6',desription = '$var',ip = '$ip',Suggesteduses = '$var1',Date_of_Entry ='$entry_date'  where latitude ='{$_POST['lat1']}' AND longitude = '{$_POST['lon1']}'");
