...
<b style="font-size:18px;font-family: 'Arial Black', Gadget, sans-serif;color:#395870;margin-left:40px;" align="left">Add Entry<br /><br /><br /></b>
 ...
 <b style="font-size:15px;font-family: 'Arial Black', Gadget, sans-serif;color:#395870;margin-left:40px;margin-top:60px;">
   ...
   <textarea name="questions" id="question8" style="margin-left:40px;background-color:#FFF;height:240px;width:400px;" wrap="hard" readonly>
  
  Have you an Idea for the Site?
    </textarea> 
    
  <textarea name="comments" id="comments"   style="margin-left:470px;background-color:#FFF;height:240px;width:395px;float:left;margin-top:-240px;margin-right:2%;" wrap="hard"  placeholder="Enter your Idea regarding the Site/Location here"></textarea> 
  </label> 
   <br/><br/>
