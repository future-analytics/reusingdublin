...
google.maps.event.addDomListener(window, 'load',initialize);
    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color:#00afc9;border:none;width:100%;">
      <div class="container" >
        ...
        <div id="navbar" class="navbar-collapse collapse" style="float:right;margin-top:-4%;">
          ...
          <div class="container-fluid"  style="height:100%;width:100%;margin-top:-10px;" >
 ...
 <div style="float:left;margin-left:2%;height:50%;background-color:#9dd7e3;width:40%;">
  
     <font  align="center" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-left:10px;">Connect</font>
    ...
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-left:10px;" align="center">Have we made a mistake</font>
    
          
     <p style="margin-left:5px;"><a href="emailphp.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">LET US KNOW &raquo;</a></p>
        </br>
        <br/><br/>
         
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;"  align="center"><b>Further info</b></font>
       
   
          
      <p style="margin-left:5px;"><a href="emailphp.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">TELL US MORE &raquo;</a></p>
       </br>
       <br/>  <br/>
         
        
        <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;margin-left:10px;"><b>Connect</b></font> 
      
      
       <p style="margin-left:5px;"><a href="Connect.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">CONNECT &raquo;</a></p>
          ...
          <font  align="center" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-left:10px;">Share</font>
     
  
                
        <br/>
          <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-left:10px;" align="center">Share</font>
    
          
     <p style="margin-left:5px;"><a href="share1.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">SHARE &raquo;</a></p>
        </br>
  
         
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-left:10px;" align="center">Upload your files</font>
    
          
     <p style="margin-left:5px;"><a href="email.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">ADD A FILE &raquo;</a></p>
        </br>
         
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;"  align="center"><b>Upload your videos</b></font>
       
   
          
      <p style="margin-left:5px;"><a href="emailphp.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">ADD A VIDEO &raquo;</a></p>
       </br>  
         
        
        <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;margin-left:10px;">Upload your photos</font> 
      
      
       <p style="margin-left:5px;"><a href="Connect.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:2vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">ADD A PHOTO &raquo;</a></p>
