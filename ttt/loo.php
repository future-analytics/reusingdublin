...
google.maps.event.addDomListener(window, 'load',initialize);
  ...
  <body onload="comments()">
    	...
    	<div class="headerLine" style="margin-top:-80px;">
...
<img src="images/logo.png">
    ...
    <div class="container-fluid"  style="height:100%;width:100%;" >
      ...
      <input type="hidden" name="lon1" ID="lon" value ="default" size="40"><br><br/><br/>
          <div style="width:100%;margin-right:80px;border:none;background-color:#FFF;padding:0px;margin-top:-120px;" class="well sidebar-nav">
   ...
   <div id="map-canvas"  style="height:150px;width:150px;float:left;margin-top:-130px;margin-left:50px;" >   </div>
         ...
         <div style="font-family:Arial, Helvetica, sans-serif;font-size:18px;color:#960;float:left;margin-left:9%;margin-top:10px;font-size:24px;font-family: Arial, Helvetica, sans-serif;" align="center" id="dem"><b></b></div> <br/><br/>
                  
        <div style="width:90%;float:left;border:hidden;opacity:0%;margin-top:20px;background-color:#FFF;" >
 ...
 <div style="float:left;margin-left:2%;height:inherit;margin-top:10px;"  class="well sidebar-nav" >
  <div style="margin-left:3px;margin-right:3px;">
    ...
    <h4 style="color:#000;" align="center"><b>REPORT A PLOT</b></h4>
    
          
     <p align="center" ><a href="emailphp.php" style="color:#FFF;"  class="btn btn-primary btn-large">Spam &raquo;</a></p>
        </br>
...
<div class="lineBlack" style="margin-bottom:-38px;height:430px;width:100%;">
			<div class="container">
                ...
                <div  class="logo col-md-4" style="width:100%;">
					...
					<div class="col-md-6 text-left copy" style="margin-bottom:10px;">
