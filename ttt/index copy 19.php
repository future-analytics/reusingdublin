...
<form id="myForm" method="post" action="index.php" enctype="multipart/form-data" autocomplete="off">
    ...
    <div style="background-color:#00afc9;position:relative;">
   ...
   <div id="news" style="position:relative;width:100%;height:70%;background-color:#00afc9;margin-top:-20px;" >
      <img src="reusing-draft-13.04-02.png" style="height:100%;width:100%;background-color:#00afc9;margin-top:35px;">
         <div  style="margin-top:-100%;margin-left:4%;">
       

      <!-- Main component for a primary marketing message or call to action -->
       <div  id="works" style="background-color:#000;height:auto;position:absolute;width:auto;" align="justify" >
      ...
      <div   style="background-color:#FFF;height:50%;margin-top:30%;position:absolute;" align="justify" >
      <div style="background-color:#FFF;">
        ...
        <p style="background-color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:1.5vw;font-weight:bold;">&nbsp;&nbsp;&nbsp   Add a space <span style="background-color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:1.5vw;font-weight:regular;"> by clicking the 'add a site' tab and &nbsp;&nbsp;&nbsp  </br> &nbsp;&nbsp;&nbsp clicking on the location on the map.</p>
                <p style="background-color:#cadd70;font-family:'Source Sans Pro', sans-serif;font-size:1.5vw;font-weight:bold;">&nbsp;&nbsp;&nbsp   Share your information <span style="background-color:#cadd70;;font-family:'Source Sans Pro', sans-serif;font-size:1.5vw;font-weight:regular;"> about the site.</p>
