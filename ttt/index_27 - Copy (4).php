...
<body onLoad="initialize()">
   ...
   <div  style="position:relative;width:100%;margin-top:5%;height:40%;" >
      <img src="reusing-draft-13.04-02.png" style="height:100%;width:100%;margin-top:5px;">
        <div  style="margin-top:-99%;position:absolute;margin-left:4%;background-attachment:fixed">
       

      <!-- Main component for a primary marketing message or call to action -->
       <div class="jumbotron" style="background-color:#000;height:90%;" align="justify" >
      ...
      <!-- Main component for a primary marketing message or call to action -->
      <div class="jumbotron" style="background-color:#FFF;height:80%;" align="justify" >
    ...
    <div class="row-fluid">
      ...
      <!-- Main component for a primary marketing message or call to action -->
      <div class="jumbotron">
     <div class="container" id="about" align="center" style="margin-top:1%;" >
<div class="row">
