...
location = c[n];
desc = d[n];
h =  '<div style="width:300px; height:180px;">' + '<b style="background-color:#f4e851;border:none;font-family:Source Sans Pro, sans-serif;font-size:17px;color:black;font-weight:600;margin-left:10px;">ADDRESS:</b>' + " " + location + '</br>' +'</br>'+ '<b style="background-color:#f4e851;border:none;font-family:Source Sans Pro, sans-serif;font-size:17px;color:black;font-weight:600;margin-left:-20px;">DESCRIPTION:</b>' + " " + desc +'</br>' + '</br>' + '<a href="ViewData.php"  style="background-color:#f4e851;border:none;font-family:Source Sans Pro, sans-serif;font-size:17px;height:40px;width:280px;color:black;font-weight:600;" class="btn btn-primary btn-large" target="_blank">LEARN MORE ABOUT THE SITE</a>' + '<br/>' + '</div>';
}
}
var infoWindow = new google.maps.InfoWindow({
  content : h 
...
<form id="myForm" method="post" action="index_27.php" enctype="multipart/form-data" autocomplete="off">
    <!-- Fixed navbar -->
        ...
        <div id="navbar" class="navbar-collapse collapse" style="float:right;margin-top:-4%;">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#contact" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">TRY IT OUT</a></li>
             ...
             <li><img style="float:left;margin-top:4px;margin-left:10px;" href="www.facebook.com" src="facebook.png"></img></li>
               <li><img style="float:left;margin-left:16px;margin-top:4px;" href="www.twitter.com"  src="twitter.png"></img></li>
   ...
   <div id="news" style="position:relative;width:100%;height:40%;background-color:#00afc9;margin-top:-20px;" >
      <img src="reusing-draft-13.04-02.png" style="height:40%;width:100%;margin-top:8%;background-color:#00afc9;">
        <div  style="margin-top:-99%;position:absolute;margin-left:4%;background-attachment:fixed">
       

      <!-- Main component for a primary marketing message or call to action -->
       <div class="jumbotron" style="background-color:#000;height:90%;margin-top:10%;" align="justify" >
   
        <p style="color:white;font-family:'Source Sans Pro', sans-serif;font-size:1.5vw;font-weight:600;">&nbsp;&nbsp;&nbsp  Welcome to Reusing Dublin ,</br> &nbsp;&nbsp;&nbsp a space to discover and share </br>&nbsp;&nbsp;&nbsp information about vacant or </br>&nbsp;&nbsp;&nbsp  underused spaces in Dublin</p>
        <p style="color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:1.0vw;font-weight:600;">&nbsp;&nbsp;&nbsp  Join us in unlocking the potential of the </br>&nbsp;&nbsp;&nbsp  spaces in our city</p>
      </div>
      ...
      <div class="jumbotron" style="background-color:#FFF;height:80%;margin-top:5%;" align="justify" >
        ...
        <p style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:1.5vw;font-weight:bold;">&nbsp;&nbsp;&nbsp  How it works   </br></p>
        <p style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:1.0vw;font-weight:600;"> &nbsp;&nbsp;&nbsp  Using the map below,discover or add</br>&nbsp;&nbsp;&nbsp information about any underused sites you</br> &nbsp;&nbsp;&nbsp have noticed.</p>
        <p style="background-color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:1vw;font-weight:bold;">&nbsp;&nbsp;&nbsp   Add a space <span style="background-color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:1vw;font-weight:regular;"> by clicking the 'add a site' tab and &nbsp;&nbsp;&nbsp  </br> &nbsp;&nbsp;&nbsp clicking on the location on the map.
        </p>
                <p style="background-color:#cadd70;font-family:'Source Sans Pro', sans-serif;font-size:1vw;font-weight:bold;">&nbsp;&nbsp;&nbsp   Share your information <span style="background-color:#cadd70;;font-family:'Source Sans Pro', sans-serif;font-size:1vw;font-weight:regular;"> about the site.
        </p>
            <p style="background-color:#9dd7e3;font-family:'Source Sans Pro', sans-serif;font-size:1vw;font-weight:bold;"> &nbsp;&nbsp;&nbsp  Connect with others <span style="background-color:#9dd7e3;;font-family:'Source Sans Pro', sans-serif;font-size:1vw;font-weight:regular;"> who might be interested </br> &nbsp;&nbsp;&nbsp  in the site.
        </p>
    ...
    <div class="row-fluid"  style="background-color:#FFF;" style="margin-top:4%;" >
...
<div id="googleMap" align="center" style="width:100%;height:600px;float:left;border:thin;"></div>
	...
	<div id="project" style="margin-top:-5px;">    	
				         
    
    
    <div class="container" style="background-color:#f4e851;width:100%;height:100%;" >
	  <div class="row">
...
our city efficiently - and sometimes we don’t use it at all.</p>
...
a wider EU FP7 project called TURAS (Transitioning towards Urban
Resilience and Sustainability).</p>
     ...
     <div class="row-fluid" style="padding-top:60px;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;"> <p>Subscribe to our newsletter email to get notification about</br>
upcoming news, latest project activities and much more!</p>
<div style=float:left;">
<input type="email" class="abc" name='email' style="background-color:#00afc9;width:250px;height:40px;float:left;border:none;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;" id='email1' placeholder="&nbsp;&nbsp;&nbsp;Your Email Address">
							<input type="submit" id="subscribe" style="background-color:#F00;color:white;height:40px;border:none;font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:600;float:left;height:40px;margin-left:-2px;" name="added" class="subS" value="SUBSCRIBE" onClick="javascript:ValidateEmail();"/>
                            <div style="float:left;">                            <img  src="reusing-drraft-13 04-03.png" style="height:80%;width:80%;margin-left:40%;"></div><div style="float:left;"><img  src="Eu_logo1.png" style="height:80%;width:80%;margin-left:80%;" ></div><div style="float:right;"> <img  src="images/turas.png"  style="height:90%;width:90%;margin-left:50%;"></div> 
                            </div>
                     </div>      
                         </div>
