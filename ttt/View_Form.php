...
google.maps.event.addDomListener(window, 'load',initialize);
 ...
 <div style="float:left;margin-left:1%;height:50%;background-color:#9dd7e3;width:50%;">
    ...
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-left:10px;" align="center">Have we made a mistake</font>
     ...
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;"  align="center"><b>Further info</b></font>
      ...
      <p style="margin-left:5px;"><a href="emailphp.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">TELL US MORE &raquo;</a></p>
       ...
       <p style="margin-left:5px;"><a href="Connect.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">CONNECT &raquo;</a></p>
                 ...
                 <div style="float:right;background-color:#cadd70;height:50%;width:49%;"  >
     ...
     <p style="margin-left:5px;"><a href="share1.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">SHARE &raquo;</a></p>
        </br>
    ...
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-left:10px;" align="center">Upload your files</font>
     ...
     <p style="margin-left:5px;"><a href="Insert1.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">ADD A FILE &raquo;</a></p>
     ...
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;"  align="center"><b>Upload your videos</b></font>
      ...
      <p style="margin-left:5px;"><a href="Insert3.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">ADD A VIDEO &raquo;</a></p>
       ...
       <p style="margin-left:5px;"><a href="Insert2.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">ADD A PHOTO &raquo;</a></p>
   <p style="font-family:'Source Sans Pro', sans-serif;font-size:3vw;" id="demos"><b></b></p> 
        </br> 
