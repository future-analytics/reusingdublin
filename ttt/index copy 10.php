...
<p>Re-using Dublin is an application developed on the observation that we don’t use space in our city efficiently - and sometimes we don’t use it at all. Yet the city continues to sprawl, commuter times are increasing and there is a serious shortfall in housing provision. Coupled with this there are areas of the city which are underused and do not provide vibrant or attractive places for living and working.</p>
...
<p>The Re-Using Dublin project considers these ‘vacant’ and underused sites to be only part of a bigger challenge. Re-Using Dublin goes a step further in attempting to map underused spaces, which we see as opportunities for using the city more efficiently for the benefit of everyone. Underused spaces include spaces that are not used at all (vacant) or that are only partly in use. It also includes spaces that may have a use, like a roof or a grassed area, but that could accommodate additional uses. It is envisaged that the identification of these might encourage the diverse reuse of underutilized spaces.  Uses related to community practices, ecosystems services, food systems, energy systems, or intensification of use.</p>
...
<div class="col-sm-6"> <img src="images/logo3.png"> </div></br>
<div class="col-sm-6" > <img src="images/turas.png"> </div>

<div style="width:100%;" align="center">
<a class="twitter-timeline" href="https://twitter.com/Reusingdublin" data-widget-id="568784229493133313">Tweets by @Reusingdublin</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
</div>
<div style="width:100%;margin-top:20px;margin-right:5px;" align="center">
<div id="fb-root"></div>
...
<div style="width:100%" class="fb-like-box" data-href="https://www.facebook.com/reusingdublin" data-width="500" data-height="500" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="true" data-show-border="true"></div>
...
<!--news start-->
    ...
    <div id="news">
		...
		<div class="container">
			...
			<div class="col-sm-6" style="float:right;margin-bottom:20px;"></br></br>
            	<iframe src="//player.vimeo.com/video/115815956?color=473409&amp" width="100%" height="400" style="float:right;margin-top:-5px;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>		
			...
			<div class="container">
				<div class="row footer">
					<div class="col-md-12">
						...
						<p>Subscribe to our newsletter email to get notification about upcoming news, latest activities and much more!</p>
						<div class="fr">
