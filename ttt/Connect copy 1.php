...
VALUES ('$latitude', '$longitude','$address', '$ans1','$ans2','$ans1','$comment')";
...
<form action="notifyssss.php" method="post" enctype="multipart/form-data" autocomplete="off">
   ...
   <div class="container-fluid">
      <div class="row-fluid">
        <div  class="span3">
           <div style="margin-left:40px;margin-right:160px;" align="justify">
           <h2 style="color:#395870;" align="center"><b>
 Tell us a little about yourself!</b></h2>
         <h3 style="color:#395870;" ><b>
 Once you do, why not post a note to tell everyone your vision for the lot? And be sure to post updates on your progress!
