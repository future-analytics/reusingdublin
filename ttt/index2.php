...
<form id="myForm" method="post" action="index.php" enctype="multipart/form-data" autocomplete="off">
   ...
   <div id="news" style="position:relative;width:100%;height:40%;background-color:#00afc9;margin-top:-20px;overflow:hidden;" >
      <img src="reusing-draft-13.04-02.png"  style="background-size: 100% auto;">
