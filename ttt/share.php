...
<div style="float:left;width:52%;" >
  ...
  <b style="font-size:16px;font-family: 'Arial Black', Gadget, sans-serif;color:#395870;margin-left:40px;" align="left">SHARE YOUR IDEAS WITH US :<br /><br /><br/></b>
    ...
    <br/>
     ...
     <label> 
  <textarea name="comment" id="commen"  rows ="5" cols ="50" style="margin-left:40px;background-color:#FFF;" wrap="hard" required  placeholder="  Enter your Information regarding the Site/Location here"></textarea> 
  </label> 
   <br/><br/>
...
Enter your Alias Name:
      ...
      <br/> <br/>
<label> 
  <input type="text" name="name1" id="name1"  style="margin-left:40px;width:417px;border:none"  required />
  </label> 
   <br/><br/>
</div> 
