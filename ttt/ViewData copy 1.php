...
google.maps.event.addDomListener(window, 'load',initialize);
  ...
  <body onload="comments()">
     ...
     <div style="background-color:#00afc9;width:100%;">
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color:#00afc9;border:none;width:100%;">
      <div class="container" style="width:100%;">
        ...
        <div class="container">
        <div  style="float:left;margin-top:-8%;margin-left:28%;width:100%;">
          <ul style="width:40%;">
            <li><a href="index.php" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;margin-left:8%;float:left;">HOME</a></li>
            <li><a href="#works" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;color:white;float:left;">LEARN MORE ABOUT THE SITE</a></li>
                         <li><a href="http://www.facebook.com" target="_blank"><img style="float:left;margin-top:4px;margin-left:10px;float:left;" href="www.facebook.com" src="facebook.png"></img></a></li>
               <li><a href="http://www.twitter.com" target="_blank"><img style="float:left;margin-left:16px;margin-top:3px;float:left;" href="www.twitter.com"  src="twitter.png"></img></a></li>
   ...
   <div id="map-canvas"  style="height:150px;width:150px;float:left;margin-top:-130px;margin-left:50px;" >   </div>
    ...
    <div class="lot-detail-information-item">
      <h2 style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:35px;margin-top:-5px;font-weight:bold;"><b>DISCOVER</b></h2>
        <h4 style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:semibold;"><b>INFORMATION ABOUT THE LOT</b></h4>
                <div class="lot-detail-information-item-label" style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:px;font-weight:semibold;">
                   Address:
                </div>
                <div class="lot-detail-information-item-value">
            <p class="test" name="comment" style="font-family:'Source Sans Pro', sans-serif;font-size:14px;font-weight:regular;color:#036A78;" id ="addres1"></p>       
                </div>
            </div>
             <div class="lot-detail-information-item">
