...
<div  style="width:100%;" id="about">
  <form method="post" id="myForm" action="index.php" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="col-md-12">
						...
						<div style="display: inline-block;">
                           <input type="hidden" name="messages" id="messages" />
							<input type="text"  id="email" name='Email' placeholder='Insert Your Email-Id' value=""/>
							<input type="submit" name='subscribe' id="subscribe1" style="background-color:#FFF;color:#000;width:100px;height:38px;font-weight:bold;"   value="Subscribe" onclick="javascript:subscribe()" />
            </form>                
						</div>
						</div>
					</div>
