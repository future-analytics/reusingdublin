...
li:active {
 ...
 .box{height:100%;width:100%;border:2px;overflow:hidden;position:relative;}
.box img{height:auto;width:100%;text-align:center;vertical-align:top;display:block;    top:0; left:0; right:0; bottom:0;
...
<form id="myForm" method="post" action="index.php" enctype="multipart/form-data" autocomplete="off">
          ...
          <ul class="nav navbar-nav">
            ...
            <li><a href="#try" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">TRY IT OUT</a></li>
             ...
             <li><a href="http://www.facebook.com" target="_blank"><img style="float:left;margin-top:4px;margin-left:10px;" href="www.facebook.com" src="facebook.png"></img></a></li>
               <li><a href="http://www.twitter.com" target="_blank"><img style="float:left;margin-left:16px;margin-top:3px;" href="www.twitter.com"  src="twitter.png"></img></a></li>
   ...
   <div id="box"  >
      <img src="reusing-draft-13.04-02.png">
         <div  style="position:absolute;margin-left:4%;">
