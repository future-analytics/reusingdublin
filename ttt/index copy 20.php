        ...
        <div id="navbar" class="navbar-collapse collapse" style="float:right;margin-top:-4%;">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#try" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">TRY IT OUT</a></li>
             ...
             <li><a href="http://www.facebook.com" target="_blank"><img style="float:!important;margin-top:4px;" href="www.facebook.com" src="facebook.png"></img></a></li>
               <li><a href="http://www.twitter.com" target="_blank"><img style="float:!important;margin-left:16px;" href="www.twitter.com"  src="twitter.png"></img></a></li>
...
<div  style="float:left;background-color:#FFF;border:none;height:40px;">
...
<option align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MORE INFORMATION&nbsp;&nbsp</option>
...
<div  style="float:left;background-color:#FFF;border:none;height:40px;" align="center">
<input type="button" class="type-3" id="additional" style="background-color:#00afc9;border:none;height:40px;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:600;float:left;margin-bottom:0px;width:180px;margin-left:3%;" align=   
"center" value="FIND AN AREA"/>
<input id="pac-input" style="width:200px;height:40px;float:left;margin-top:-40px;width:400px;color:#00afc9;border:none;font-size:24px;" type="text" placeholder="&nbsp;&nbsp;&nbsp; SEARCH BOX" >
...
called TURAS (Transitioning towards Urban Resilience and Sustainability).</
     ...
     <div class="container" id="mail" style="padding-top:60px;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;"> <p>Subscribe to our newsletter email to get notification about</br>
...
<input type="email" class="abc" name='email' style="background-color:#00afc9;width:250px;height:40px;float:left;border:none;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;" id='email1' placeholder="&nbsp;&nbsp;&nbsp;Your Email Address">
							<input type="submit" id="subscribe" style="background-color:#F00;color:white;height:40px;border:none;font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:600;float:left;height:auto;margin-left:-2px;" name="added" class="subS" value="SUBSCRIBE" onClick="javascript:ValidateEmail();"/>
                            
                                                       <img  src="reusing-drraft-13 04-03.png" style="height:auto;width:auto;float:!important;"><img  src="Eu_logo1.png" style="height:auto;width:auto;float:!important;" ><img  src="images/turas.png"  style="height:auto;width:auto;float:!important;">
