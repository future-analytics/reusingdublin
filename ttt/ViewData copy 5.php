...
<form id="myForm" method="post" action="ViewData.php" enctype="multipart/form-data" autocomplete="off">
   ...
   <div id="map-canvas"  style="height:150px;width:150px;float:left;margin-top:-130px;margin-left:50px;" >   </div>
         ...
         <div style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:40px;font-weight:bold;float:left;margin-left:3%;margin-top:10px;" align="center" id="dem"><b></b></div> <br/><br/>
                  
        <div class="container" style="width:90%;float:left;background-color:inherit;border:hidden;opacity:0%;margin-top:20px;" >
      ...
      <div class="lot-detail-information"  style="float:left;margin-top:-8px;background-color:#FFF;border-color:#FFF;" >
    <div class="lot-detail-main-section">
    <div class="lot-detail-information-item">
      <h2 style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:40px;margin-top:-5px;font-weight:bold;"><b>DISCOVER</b></h2>
        <h4 style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:semibold;"><b>INFORMATION ABOUT THE LOT</b></h4>
            ...
            <p class="test" name="comment" style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;color:#036A78;" id ="addres1"></p>       
                </div>
            </div>
             <div class="lot-detail-information-item">
                <div class="lot-detail-information-item-label" style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:semibold;">
                ...
                <div class="lot-detail-information-item-value">
                    <p class="test" name="comment1" style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;" id ="addres2"></p> 
              ...
              <div class="lot-detail-information-item">
                ...
                <div class="lot-detail-information-item-value">
                 <p class="test" name="comment2" style="font-family:'Source Sans Pro', sans-serif;font-size:20px;color:#036A78;font-weight:regular;" id ="addres3"></p>  
             ...
             <div class="lot-detail-information-item">
                ...
                <div class="lot-detail-information-item-value">
                 <p class="test" name="comment3" style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;color:#036A78;" id ="addres4"></p>  
                ...
                <div class="lot-detail-information-item-value">
                <p class="test" name="comment4" style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;color:#036A78;" id ="addres5"></p> 
                </div>
            </div>
            <div class="lot-detail-information-item">
                <div class="lot-detail-information-item-label" style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:semibold;">
               Heritage Designation:
                ...
                <div class="lot-detail-information-item-value">
                <p class="test" name="comment5" style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;color:#036A78;" id ="addres6"></p> 
                </div>
            </div>
              <div class="lot-detail-information-item">
                <div class="lot-detail-information-item-label" style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:semibold;">
               Is the site officially derelict?:
                ...
                <div class="lot-detail-information-item-value">
                <p class="test" name="comment6" style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;color:#036A78;" id ="addres7"></p>  
                </div>
            </div>
               <div class="lot-detail-information-item">
                <div class="lot-detail-information-item-label" style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:semibold;">
               Description:
                ...
                <div class="lot-detail-information-item-value">
                 <p class="test" name="comment7" style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;color:#036A78;" id ="addres8"></p>
                </div>
            </div>
              <div class="lot-detail-information-item">
                <div class="lot-detail-information-item-label" style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:semibold;">
              Suggested Uses:
                ...
                <div class="lot-detail-information-item-value">
                    <p class="test" name="comment8" style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;color:#036A78;" id ="addres9"></p>
                </div>
            </div>
             <div class="lot-detail-information-item">
                <div class="lot-detail-information-item-label" style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:semibold;">
             Why has this area been highlighted
                ...
                <div class="lot-detail-information-item-value" style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;">
 ...
 <div style="float:left;margin-left:2%;height:60%;background-color:#9dd7e3;width:40%;">
    ...
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-left:10px;" align="center">Have we made a mistake</font>
     ...
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;"  align="center"><b>Further info</b></font>
      ...
      <p style="margin-left:5px;"><a href="emailphp.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">TELL US MORE &raquo;</a></p>
       ...
       <p style="margin-left:5px;"><a href="Connect.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">CONNECT &raquo;</a></p>
                 ...
                 <div style="float:right;background-color:#cadd70;height:50%;width:45%;"  >
     ...
     <p style="margin-left:5px;"><a href="emailphp.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">SHARE &raquo;</a></p>
        </br>
    ...
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-left:10px;" align="center">Upload your files</font>
     ...
     <p style="margin-left:5px;"><a href="emailphp.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">ADD A FILE &raquo;</a></p>
     ...
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;"  align="center"><b>Upload your videos</b></font>
      ...
      <p style="margin-left:5px;"><a href="emailphp.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">ADD A VIDEO &raquo;</a></p>
       ...
       <p style="margin-left:5px;"><a href="Connect.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">ADD A PHOTO &raquo;</a></p>
