...
//Clustering all the official utilised and underutilised markers.
...
<iframe src="//player.vimeo.com/video/115815956?color=473409&amp;autoplay=1" width="100%" height="400" style="float:right;margin-top:-5px;" frameborder="0" webkitallowfullscreen    
...
<h11> RE-USING DUBLIN PROVIDES A SPACE FOR DUBLINERS TO DISCOVER AND SHARE INFORMATION ON VACANT / UNDERUTILISED SPACES AND TO CONNECT WITH OTHERS ABOUT THIS TOPIC.</h11>
 </br></br>
...
<div id="legend" type="hidden" style="background-color:#FFF;padding:4px;">
<h4 style="color:#000;float:left;margin-left:10px;">Legends:</h4>
<h4 style="color:#000;float:left;margin-left:10px;">Opportunity Spaces</h4>
<img src="http://www.factest.ie/timber/icon3.png" style="margin-left:10px;float:left;"  height="20px" width="20px"/>
<h4 style="color:#000;float:left;margin-left:10px;"> Underutilised Spaces</h4>
<img src="http://www.factest.ie/timber/icon2.png" style="margin-left:10px;float:left;color:white;" height="20px" width="20px"/>
</div>
...
align="center" value="Discover All Sites" onClick="javascript:showentry()" onMouseOver="javascript:changecolor()" />
</div>
<div  class="col-md-3" style="float:left;background-color:#FFF;border:none;height:40px;">
<select  style="background-color:#060;border:none;height:40px;color:#FFF;font-size:20px;float:left;margin-left:1px;text-align:center;width:180px;" class="type-3"  id="pac-input1" align= 
...
<!--news start-->
    ...
    <div id="news">
		...
		<div class="container">
			...
			<div class="col-sm-6" style="float:right;margin-bottom:20px;"></br></br>
            	<iframe src="//player.vimeo.com/video/115815956?color=473409&amp;autoplay=1" width="100%" height="400" style="float:right;margin-top:-5px;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>		
