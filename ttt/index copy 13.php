...
function myFunction()
{
window.open("Entry_Form.php","Ratting","width=550,height=500,0,status=0,");
...
<form id="myForm" method="post" action="index.php" enctype="multipart/form-data" autocomplete="off">
   ...
   <div id="news" style="position:relative;width:100%;height:40%;background-color:#00afc9;margin-top:-20px;" >
      <img src="reusing-draft-13.04-02.png" style="height:-5%;width:100%;background-color:#00afc9;">
...
called TURAS (Transitioning towards Urban Resilience and Sustainability).</
     ...
     <div class="row-fluid"id="mail" style="padding-top:60px;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;"> <p>Subscribe to our newsletter email to get notification about</br>
