...
google.maps.event.addDomListener(window, 'load',initialize);
 ...
 <body onload="initialize()" style="background-color:#f4e851">
  ...
  <?php echo $msg ?>
            ...
            <font style="font-family:'Source Sans Pro', sans-serif;font-size:40px;font-weight:bold;"><b>Update a space</font>
            <br/>
            <br/>
 ...
 <b style="font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:regular;float:left;width:100%;margin-left:1%;margin-right:1%;">
  ...
  <textarea name="comment" id="commen"   style="font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:regular;float:left;width:100%;height:240px;" wrap="hard"  placeholder="Enter your Idea regarding the site/location here"></textarea> 
   ...
   <label >
     ...
     <button onClick="myFunction(); return false;" style="background-color:#00afc9;color:#FFF;margin-left:40px;height:50px;width:100%;">ADD A PHOTO</button>
    </label>
   <br/><br/>
...
<input type="button" name="submits"  style="font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:regular;float:left;width:22%;background-color:#00afc9;color:white;" value="BACK"  onClick="javascript:goback()"/ >      
