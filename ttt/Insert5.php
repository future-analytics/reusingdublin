				...
				<div class="logo col-md-4">
                  ...
                  <div class="col-md-8">
                   <div clas="navmenu" style="float:right">
														...
														<a onclick="cll();" class="hhh"  style="color:white;margin-right:50%;font-weight:200">HOME</a>
...
<input type="button" name="submits" class="btn btn-embossed btn-primary" value="Back"  onClick="javascript:goback();return false;"/ >      
<input type="submit" name="added" class="btn btn-primary btn-large" value="Upload" onClick="javascript:show();return false;" />
</div>
