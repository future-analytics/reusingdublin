...
<!--home start-->
   ...
   <div style="margin-top:5%;position:relative;" >
      ...
      <div class="jumbotron" style="background-color:#000;width:48%;" align="justify" >
      
        <p style="color:white;font-family:'Source Sans Pro', sans-serif;font-size:2.5vh;font-weight:600;">Welcome to Reusing Dublin ,</br> a space to discover and share </br>information about vacant or </br> underused spaces in Dublin</p>
        <p style="color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:1.5vh;font-weight:600;">Join us in unlocking the potential of the </br> spaces in our city</p>
      </div>
      ...
      <!-- Main component for a primary marketing message or call to action -->
      <div class="jumbotron" style="background-color:#FFF;width:48%;" align="justify" >
      
        <p style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:2.5vh;font-weight:bold;">How it works</br></p>
        <p style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:1.5vh;font-weight:600;">Using the map below,discover or add</br>information about any underused sites you</br> have noticed.</p>
        <p style="background-color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:1.5vh;font-weight:bold;">Add a space <span style="background-color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:1.5vh;font-weight:regular;">by clicking the 'add a site' tab and </br> clicking on the location on the map.
        </p>
                <p style="background-color:#cadd70;font-family:'Source Sans Pro', sans-serif;font-size:1.5vh;font-weight:bold;">Share your information <span style="background-color:#cadd70;;font-family:'Source Sans Pro', sans-serif;font-size:1.5vh;font-weight:regular;">about the site.
        </p>
            <p style="background-color:#9dd7e3;font-family:'Source Sans Pro', sans-serif;font-size:1.5vh;font-weight:bold;">Connect with others <span style="background-color:#9dd7e3;;font-family:'Source Sans Pro', sans-serif;font-size:1.5vh;font-weight:regular;">who might be interested </br> in the site.
        </p>
