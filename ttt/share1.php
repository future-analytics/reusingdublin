...
<div>
    ...
    <div class="container">
       ...
       <div class="container-fluid">
        <div style="margin-left:50px;font-family: Arial, Helvetica, sans-serif;font-weight:bold;color:#960;font-family: Arial, Helvetica, sans-serif;font-weight:1000;font-size:36px;" >
<?php echo $msg; ?>
  </div>
      <div class="row-fluid">
        <div  class="span3">
...
<div style="float:left;width:52%;" >
  ...
  <b style="font-size:16px;font-family: 'Arial Black', Gadget, sans-serif;color:#395870;margin-left:40px;" align="left">SHARE YOUR IDEAS WITH US :<br /><br /></b>
     <div style="margin-left:40px;">
     <b style="font-size:15px;font-family: 'Arial Black', Gadget, sans-serif;color:#395870;margin-top:60px;">
    Tell me something about this Site/Location as Suggested Below(Example Questions):
      ...
      <br/>
      <label> 
      <select style="margin-left:40px;background-color:#FFF;height:28px;width:400px;font-size:15px;font-family: 'Arial Black', Gadget, sans-serif;color:#395870;">
    ...
    <br/>
     ...
     <label> 
  <textarea name="comment" id="commen"  style="margin-left:40px;background-color:#FFF;width:400px;" wrap="hard" required  placeholder="  Enter your Information regarding the Site/Location here"></textarea> 
  </label> 
   <br/><br/>
...
Enter your Alias Name:
      ...
      <br/> <br/>
<label> 
  <input type="text" name="name1" id="name1"  style="margin-left:40px;width:380px;border:none"  required />
  </label> 
   <br/><br/>
</div> 
...
<br/>
     ...
     <div style="border:none;margin-left:140px;">
...
<br/>
 <input type="hidden" name="lat1" ID="lat" value ="default" size="40"><br><br/><br/>
      ...
      <input type="hidden" name="date" ID="date" value ="default" size="40"><br><br/><br/>
</form>  
