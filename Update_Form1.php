...
$stmt->bindParam(':owner', $ans1);
$stmt->bindParam(':zoning', $ans2);
$stmt->bindParam(':dates', $dates);
$stmt->bindParam(':planningistory', $ans3);
$stmt->bindParam(':size', $ans4);
$stmt->bindParam(':derelict', $ans5);
$stmt->bindParam(':heritage', $ans6);
...
google.maps.event.addDomListener(window, 'load',initialize);
 ...
 <body onload="initialize()" style="background-color:#f4e851">
                       ...
                       <form name="form1"  action="Update_Form1.php" method="post"  enctype="multipart/form-data" autocomplete="off">
