...
<form id="myForm" method="post" action="index.php" enctype="multipart/form-data" autocomplete="off">
    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color:#00afc9;border:none;width:100%;">
      <div class="container" >
        ...
        <div id="navbar" class="navbar-collapse collapse" style="float:right;">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#works" data-scroll="works" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">HOW IT WORKS</a></li>
            <li><a href="#try" data-scroll="try"  style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">TRY IT OUT</a></li>
              <li><a href="#about" data-scroll="about"  style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">ABOUT</a></li>
     ...
     <div class="news" data-anchor="news" style="background-image:url('reusing-draft-13.04-02.png');background-size:cover; display: inline-block;width:100%; height:auto;">
...
<div  class="col-md-4" style="margin-top:7%;float:left;margin-left:3%;" >
      <div class="jumbotron"  id="works" style="background-color:#022a3c;height:auto;margin-top:5%;"  >
...
<div   class="container" data-anchor="try" style="padding-top:20px;margin-left:2%;" align="center">
<div  class="col-md-4"  style="margin-bottom:5px;">
<input type="button" id="try" data-anchor="try" style="background-color:#00afc9;border:none;height:40px;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:600;margin-bottom:0px;" align=   
...
Resilience and Sustainability).
     ...
     <div class="container" id="mail" data-anchor="mail" style="padding-top:60px;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;" align="center"> <p>Subscribe to our newsletter email to get notification about</br>
