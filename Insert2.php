...
|| ($_FILES["pic"]["type"] == "image/png")||($_FILES["pic"]["type"] == "image/tiff")||($_FILES["pic"]["type"] == "image/bmp")))
{
	...
	$sql3="insert into photo (latitude,longitude,Picname) values ('$latitude','$longitude','$file_name')"; 
...
|| ($_FILES["pic"]["type"] == "image/png")||($_FILES["pic"]["type"] == "image/tiff")||($_FILES["pic"]["type"] == "image/bmp")))
{
	...
	$sql3="Update photo SET  Picname = '$file_name'  where latitude ='$latitude' AND longitude  = '$longitude'"; 
...
<body onload="initialize()" style="background-color:#f4e851">
                       ...
                       <form   action="Insert2.php" method="post"  enctype="multipart/form-data" autocomplete="off">
...
<div style="margin-left:100px;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:bold;color:#960;">
  ...
  <br>
<b style="font-size:16px;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;color:#395870;margin-top:5%;" align="left">Upload photograph for the site/location<br/><br/> 
</b>
 ...
 <b style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;margin-left:40px;">
    Insert Photograph:</b>
     <br/><br/>
     <label>
...
<input type="button" name="submits"  style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;float:left;width:42%;background-color:#00afc9;color:white;" value="BACK"  onClick="javascript:goback()"/ >      
