...
<form id="myForm" method="post" action="index.php" enctype="multipart/form-data" autocomplete="off">
   ...
   <div id="news"  style="position:relative;width:100%;height:100%;background-color:#00afc9;margin-top:-20px;overflow:hidden;" >
      ...
      <div class="box"  style="background-color:#FFF;height:80%;margin-top:5%;" align="justify" >
