 ...
 <b style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;float:left;width:100%;margin-left:1%;margin-right:1%;">
  ...
  <textarea name="comment" id="commen"   style="font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:regular;float:left;width:100%;height:240px;" wrap="hard"  placeholder="Enter your Idea regarding the site/location here"></textarea> 
   ...
   <label >
     ...
     <button  style="background-color:#00afc9;color:#FFF;margin-left:40px;height:50px;width:100%;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;" onClick="myFunction(); return false;" >ADD A PHOTO</button>
    </label>
       <br/><br/>
       
   <label >
     
     <button  style="background-color:#00afc9;color:#FFF;margin-left:40px;height:50px;width:100%;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;" onClick="myFunction1(); return false;" >ADD A FILE</button>
    </label>
      <br/><br/>
