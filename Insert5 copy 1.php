...
function cll()
{
 ...
 <body onload="initialize()" style="background-color:#f4e851">
  ...
  <?php echo $msg ?>
            ...
            <font style="font-family:'Source Sans Pro', sans-serif;font-size:40px;font-weight:bold;"><b>Insert a photo</font>
            <br/>
            <br/>
...
<input type="button" name="submits"  style="font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:regular;float:left;width:22%;background-color:#00afc9;color:white;" value="BACK"  onClick="javascript:goback();return false;"/ >      
<input type="submit" name="added" style="font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:regular;float:left;width:24%;background-color:#00afc9;color:white;" value="UPLOAD" onClick="javascript:show();return false;" />
</div>
