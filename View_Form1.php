...
document.getElementById('lat').value = <?php echo $param1;?>;
document.getElementById('lon').value = <?php echo $param2;?>;
...
google.maps.event.addDomListener(window, 'load',initialize);
 ...
 <body onload="comments()">
                       ...
                       <form name="form1"  action="View_Form1.php" method="post"  enctype="multipart/form-data" autocomplete="off">
