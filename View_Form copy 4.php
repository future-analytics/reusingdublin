...
google.maps.event.addDomListener(window, 'load',initialize);
 ...
 <body onload="comments()">
   ...
   <div id="map-canvas"  style="height:150px;width:150px;float:left;margin-top:-130px;margin-left:50px;" >   </div>
             ...
             <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:bold;margin-top:10px;height:20px;width:100%;" align="center"  id="dem"></font> <br/>
          ...
          <div style="width:100%;margin-right:80px;border:none;background-color:#FFF;padding:0px;background-color:transparent;border:none;" class="well sidebar-nav">
             ...
             <br/>
             <br/>
                <h4 style="color:#036A78;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:bold;margin-left:2%;"><b>DISCOVER</b></h4>  
 ...
 <div class="col-md-4" style="background-color:#9dd7e3;padding:3%;">
    ...
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;" align="center">Have we made a mistake</font>
     ...
     <p style="margin-left:3%;"><a href="email.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;margin-top:10px;"  class="btn btn-primary btn-large">LET US KNOW</a></p>
        </br>
        <br/><br/>
         
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:20px;margin-left:3%;font-weight:semibold;margin-top:10px;"  align="center"><b>Further info</b></font>
       
   
          
      <p style="margin-left:3%;"><a href="email.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;margin-top:10px;" class="btn btn-primary btn-large">TELL US MORE</a></p>
       </br>
       <br/>  <br/>
         
        
        <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;margin-top:10px;margin-left:10px;"><b>Connect</b></font> 
       ...
       <p style="margin-left:3%;"><a href="connects.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;margin-top:10px;" class="btn btn-primary btn-large">CONNECT</a></p>
                 ...
                 <div class="col-md-4" style="background-color:#cadd70;margin-left:2%;"  >
    ...
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;margin-left:3%;" align="center">Upload your files</font>
     ...
     <p style="margin-left:5px;"><a href="Insert1.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:20px;margin-left:3%;font-weight:semibold;margin-top:10px;"  class="btn btn-primary btn-large">ADD A FILE</a></p>
       <p style="font-family:'Source Sans Pro', sans-serif;font-size:17px;" id="demoos"><b></b></p> 
        </br>
         
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;margin-left:3%;margin-top:10px;"  align="center"><b>Upload your videos</b></font>
      ...
      <p style="margin-left:5px;"><a href="Insert3.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:20px;margin-left:3%;font-weight:semibold;margin-top:10px;" class="btn btn-primary btn-large">ADD A VIDEO</a></p>
        <p style="font-family:'Source Sans Pro', sans-serif;font-size:17px;" id="demooos"><b></b></p>
       </br>  
       ...
       <p style="margin-left:5px;"><a href="Insert2.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:20px;margin-left:3%;font-weight:semibold;margin-top:10px;" class="btn btn-primary btn-large">ADD A PHOTO</a></p>
          <p style="font-family:Arial, Helvetica, sans-serif;font-family:'Source Sans Pro', sans-serif;font-size:17px;" id="demos"><b></b></p>
      ...
      <div  class="col-md-8" style="width:100%;background-color:#FFF;border:none;float:left;padding:6%;" >
           <font style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;"><b>BLOGS</b></font>
            <p style="font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:semibold;" id="demo"><b></b></p>
            </div>
