...
<form id="myForm" method="post" action="index.php" enctype="multipart/form-data" autocomplete="off">
    ...
    <div id="news" style="background-color:#000;" >
	...
	<div  class="col-md-4">
      ...
      <div style="padding:5%">
        ...
        <p style="color:white;font-family:'Source Sans Pro', sans-serif;font-size:40px;font-weight:600;">Welcome to Reusing Dublin, a space to discover and share information about vacant or underused spaces in Dublin</p>
...
<div   style="float:left;background-color:#FFF;border:none;width:100%;margin-top:10px;margin-left:3%;" >
<div  class="col-md-4" style="margin-bottom:5px;">
<input type="button" id="additional" style="background-color:#00afc9;border:none;height:40px;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:600;margin-bottom:0px;" align=   
...
<div  class="col-md-4" style="margin-bottom:5px;float:right:"> 
<input type="button"  id="additional" style="background-color:#00afc9;border:none;height:40px;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:600;margin-bottom:0px;" align=   
"center" value="FIND AN AREA"/>
<input id="pac-input" style="color:#00afc9;border:none;font-size:17px;" type="text" placeholder="SEARCH BOX" >
<input type="button" id="layer8" style="background-color:#8ec63f;border:none;font-size:17px;background-color:#F00;color:#000;" value="GO"  onClick=   
"javascript:searc()"/>
