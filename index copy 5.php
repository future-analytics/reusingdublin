...
<form id="myForm" method="post" action="index2.php" enctype="multipart/form-data" autocomplete="off">
	...
	<div  class="col-md-8" style="margin-top:10%;">
      ...
      <!-- Main component for a primary marketing message or call to action -->
       <div class="jumbotron"  style="background-color:#009;height:80%;" align="justify" >
      <div style="padding:5%">
      
        <p style="color:white;font-family:'Source Sans Pro', sans-serif;font-size:40px;font-weight:bold;margin-top:1%;">Welcome to Reusing Dublin,a space to<br><br> discover and share information about<br><br> vacant or underused spaces in Dublin</p><br>
