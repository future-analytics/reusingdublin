...
contents = '<div id="ppp" style="width:280px; height:150px;">' + '<a href="Entry_Form1.php" onclick="goclicky(this); return false;" target="_blank" style="background-color:#f4e851;border:none;font-family:Source Sans Pro, sans-serif;font-size:17px;height:40px;width:280px;color:black;font-weight:600;" class="btn btn-primary btn-large"  >ENTER THE DESCRIPTION</a>' + '<br/>' +'<a href="Update_Form1.php" onclick="goclicky(this); return false;" target="_blank"   style="background-color:#f4e851;border:none;height:40px;width:280px;;margin-top:5px;color:black;font-size:17px;font-weight:600;font-family:Source Sans Pro, sans-serif" class="btn btn-primary btn-large" target="_blank">UPDATE THE DESCRIPTION</a>' + '<br/>' + '<a href="View_Form1.php" onclick="Postdata();" style="background-color:#f4e851;border:none;height:40px;width:280px;color:black;margin-top:5px;font-size:17px;font-family:Source Sans Pro, sans-serif;font-weight:600;" class="btn btn-primary btn-large" target="_blank">VIEW THE DESCRIPTION</a>' + '</div>' ;
...
document.getElementById("lon").value = lat1;
document.getElementById("lat").value = lon1;
...
var latsn = latlnn.lng();
 document.getElementById("lon").value = latsn;
 var x  = document.getElementById("lon").value;
  document.getElementById("lat").value = lngsn;
 var y  = document.getElementById("lat").value;
 alert(x);
  alert(y);
b1 = '<div style="width:280px; height:150px;">' + '<a  href="Entry_Form1.php" onclick="goclicky(this); return false;" target="_blank"  style="font-size:17px;font-family:Source Sans Pro, sans-serif;font-weight:600;background-color:#f4e851;border:none;color:black;height:40px;width:280px;" class="btn btn-primary btn-large" target="_blank" >ENTER THE DESCRIPTION</a>' + '<br/>' +'<a href="Update_Form1.php" onclick="goclicky(this); return false;" target="_blank"  style="background-color:#f4e851;border:none;height:40px;width:280px;color:black;margin-top:5px;font-size:17px;font-size:17px;font-family:Source Sans Pro, sans-serif;font-weight:600;" class="btn btn-primary btn-large" target="_blank">UPDATE THE DESCRIPTION</a>' + '<br/>' + '<a href="View_Form1.php" onclick="Postdata();"  style="background-color:#f4e851;border:none;height:40px;width:280px;color:black;margin-top:5px;font-size:17px;font-size:17px;font-family:Source Sans Pro, sans-serif;font-weight:600;" class="btn btn-primary btn-large" target="_blank">VIEW THE DESCRIPTION</a>' + '</div>' ;document.getElementById("lon").value = latsn ;
document.getElementById("lat").value = lngsn;
alert(latsn);
alert(lngsn);
...
<form id="myForm" method="post" action="test1.php" enctype="multipart/form-data" autocomplete="off">
  <input type="hidden" name ="lat1" id="lat"  />
    <input type="hidden" name ="lon1" id="lon" />
    <!-- Fixed navbar -->
      ...
      <div class="container" >
        ...
        <div id="navbar" class="navbar-collapse collapse" style="float:right;">
          <ul class="nav navbar-nav">
            <li><a href="#menu1" class="active" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">HOME</a></li>
            <li><a href="#menu2" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">HOW IT WORKS</a></li>
            <li><a href="#menu3" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">TRY IT OUT</a></li>
              <li><a href="#menu4" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">ABOUT</a></li>
           
             <li><a href="#menu5" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">MAILING LIST</a></li>
...
Resilience and Sustainability).
     ...
     <div class="container"  style="padding-top:60px;font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:regular;" align="center"> <p>Subscribe to our newsletter email to get notification about</br>
