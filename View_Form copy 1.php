...
google.maps.event.addDomListener(window, 'load',initialize);
 ...
 <div style="float:left;margin-left:5%;height:60%;background-color:#9dd7e3;width:45%;">
    ...
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-left:3%;" align="center">Have we made a mistake</font>
    
          
     <p style="margin-left:3%;"><a href="emailphp.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">LET US KNOW</a></p>
        </br>
        <br/><br/>
         
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;margin-left:3%;font-weight:bold;margin-top:10px;"  align="center"><b>Further info</b></font>
       
   
          
      <p style="margin-left:3%;"><a href="emailphp.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">TELL US MORE</a></p>
       </br>
       <br/>  <br/>
       ...
       <p style="margin-left:3%;"><a href="Connect.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">CONNECT</a></p>
          ...
          <font  align="center" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-left:3%;">Share</font>
     
        <br/>
        <br/><br/>

          <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-left:3%;" align="center">Share</font>
    
          
     <p style="margin-left:5px;"><a href="share.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;margin-left:3%;font-size:3vw;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">SHARE</a></p>
        </br>
  
         
    <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-left:3%;" align="center">Upload your files</font>
    
          
     <p style="margin-left:5px;"><a href="InsertDoc.php" style="color:#FFF;color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;margin-left:3%;font-weight:bold;margin-top:10px;"  class="btn btn-primary btn-large">ADD A FILE</a></p>
       <p style="font-family:'Source Sans Pro', sans-serif;font-size:3vw;" id="demoos"><b></b></p> 
        </br>
         
     <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-left:3%;margin-top:10px;"  align="center"><b>Upload your videos</b></font>
       
   
          
      <p style="margin-left:5px;"><a href="InsertVideos.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;margin-left:3%;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">ADD A VIDEO</a></p>
        <p style="font-family:'Source Sans Pro', sans-serif;font-size:3vw;" id="demooos"><b></b></p>
       </br>  
         
        
        <font style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:3vw;font-weight:bold;margin-top:10px;margin-left:3%;">Upload your photos</font> 
      
      
       <p style="margin-left:5px;"><a href="InsertPhotographs.php" style="color:#FFF;font-family:'Source Sans Pro', sans-serif;font-size:3vw;margin-left:3%;font-weight:bold;margin-top:10px;" class="btn btn-primary btn-large">ADD A PHOTO</a></p>
      ...
      <div class="well sidebar nav" style="float:right;margin-right:50%;width:100%;background-color:#FFF;border:none;">
           <h4 style="margin-top:0px"><b>BLOGS</b></h4>
            <p style="font-family:'Source Sans Pro', sans-serif;font-size:3vw;" id="demo"><b></b></p>
            </div>
           </div> 
