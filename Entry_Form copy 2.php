...
function myFunction1()
	{
		...
		window.open("Insert1.php",'Ratting',"height=700,width=700,scrollbars=1");
 ...
 <b style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;float:left;width:100%;margin-left:1%;margin-right:1%;">
  ...
  <textarea name="comment" id="commen"   style="font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:regular;float:left;width:100%;height:240px;" wrap="hard"  placeholder="Enter your Idea regarding the site/location here"></textarea> 
   ...
   <label >
    ...
    <button onClick="myFunction();" target="_blank" style="background-color:#00afc9;color:#FFF;margin-left:40px;height:50px;width:100%;font-family:'Source Sans Pro', sans-serif;font-weight:semibold;font-size:20px;" >ADD A PHOTO</button>
    </label>
   <br/><br/>
   
   <label >
     
    <button onClick="myFunction1();" target="_blank" style="background-color:#00afc9;color:#FFF;margin-left:40px;height:50px;width:100%;font-family:'Source Sans Pro', sans-serif;font-weight:semibold;font-size:20px;" >ADD A FILE</button>
    </label>
   <br/><br/>
