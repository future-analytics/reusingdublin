...
<form id="myForm" method="post" action="index2.php" enctype="multipart/form-data" autocomplete="off">
    <!-- Fixed navbar -->
    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color:#00afc9;border:none;width:100%;">
          ...
          <ul class="nav navbar-nav">
            ...
            <li><a href="#try" style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:19px;">TRY IT OUT</a></li>
             ...
             <li><a href="https://www.facebook.com/reusingdublin/" target="_blank"><img style="float:!important;" href="https://www.facebook.com/reusingdublin/" src="facebook.png"></img></a></li>
               <li><a href="https://www.facebook.com/reusingdublin/" target="_blank"><img style="float:!important;" href="https://www.twitter.com/reusingdublin/"  src="twitter.png"></img></a></li>
     ...
     <div id="news" style="background-image:url('reusing-draft-13.04-02.png');background-size:cover;margin-top:1%; display: inline-block;width:100%; height:auto;">
	...
	<div  class="col-md-8" style="margin-top:10%;">
      ...
      <div style="padding:5%">
        ...
        <p style="color:white;font-family:'Source Sans Pro', sans-serif;font-size:40px;font-weight:600;margin-top:1%;">Welcome to Reusing Dublin, a space to discover and share information about vacant or underused spaces in Dublin</p>
      ...
      <!-- Main component for a primary marketing message or call to action -->
<div  class="col-md-8">
      <div class="jumbotron"  id="works" style="background-color:#FFF;height:80%;margin-top:5%;" align="justify" >
      
      <div style="padding:5%">
        <p style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:40px;font-weight:bold;">How it works</p>
        <p style="color:#000;font-family:'Source Sans Pro', sans-serif;font-size:28px;font-weight:600;">Using the map below, discover or add information about any underused sites you have noticed.</p>
        <p style="background-color:#f4e851;font-family:'Source Sans Pro', sans-serif;font-size:28px; padding:10px" >Add a space by clicking the 'add a site' tab and clicking on the location on the map.</p>
                <p style="background-color:#cadd70;font-family:'Source Sans Pro', sans-serif;font-size:28px;padding:10px"><span style="font-weight:800">Share your information</span> about the site.   </p>
            <p style="background-color:#9dd7e3;font-family:'Source Sans Pro', sans-serif;font-size:28px;padding:10px;"><b>Connect with others</b> who might be interested in the site.   </p>
      </div>
      </div>
      </div>
      </div>
...
<div   class="container" style="padding-top:20px;margin-left:0px;margin-right:0px;">
...
<input id="pac-input" style="color:#00afc9;border:none;font-size:17px;float:left;" type="text" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; SEARCH BOX" >
<input type="button" id="layer8" style="background-color:#8ec63f;border:none;float:left;font-size:17px;background-color:#F00;color:#000;" value="GO"  onClick=   
"javascript:searc()"/>
<br/>
<br/>
<br/>
