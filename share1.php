...
<html lang="en">
  <head>
    ...
    <title>Share Information Details</title>
...
document.getElementById("date").value = today;
 ...
 <body onload="initialize()" style="background-color:#f4e851">
                       ...
                       <form   action="share1.php" method="post"  enctype="multipart/form-data" autocomplete="off">
  ...
  <?php echo $msg ?>
            ...
            <font style="font-family:'Source Sans Pro', sans-serif;font-size:40px;font-weight:bold;"> Share your ideas with us!</font><br/>
   ...
   <div id="map-canvas"  style="height:300px;width:45%;float:right;" >   </div>
    ...
    Tell me something about this Site/Location as Suggested Below(Example Questions):
      ...
      <select style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:semibold;float:left;width:100%;">
    ...
    <option value="6" >What is happening on this site?</option>
      ...
      <label style="width:100%;" > 
  <textarea name="comment" id="commen"  style="font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:regular;float:left;width:100%;" wrap="hard" required  placeholder="  Enter your Information regarding the Site/Location here"></textarea> 
  </label> 
   <br/><br/>
...
Enter your Alias Name:
      ...
      <br/> <br/>
<label style="width:100%;"> 
  <input type="text" name="name1" id="name1"  style="font-family:'Source Sans Pro', sans-serif;font-size:17px;font-weight:regular;float:left;width:100%;"  required />
  </label> 
   <br/><br/>
    <br/><br/>
...
<input type="button" name="submits"  style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:bold;float:left;width:42%;background-color:#00afc9;color:white;" value="BACK"  onClick="javascript:goback()"/ >      
<input type="submit" name="added" style="font-family:'Source Sans Pro', sans-serif;font-size:20px;font-weight:bold;float:left;width:44%;background-color:#00afc9;color:white;" value="UPLOAD"  onClick="javascript:show()"/ >
</div>
