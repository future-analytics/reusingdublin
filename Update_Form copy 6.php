...
$ans6 = mysqli_real_escape_string($con, $_POST['address6']);
$ans7 = mysqli_real_escape_string($con, $_POST['comments']);
$dates = mysqli_real_escape_string($con, $_POST['date1']);
$var1 = nl2br(htmlspecialchars(stripslashes($ans7)));
...
$sql4=("UPDATE  SiteDetails SET adress = '$address',owner = '$ans1',zoning ='$ans2',planningistory = '$ans3' , size = '$ans4',derelict= '$ans5' ,heritage = '$ans6',desription = '$var',ip = '$ip',Suggesteduses = '$var1' ,Date_of_Entry = '$dates' where latitude ='{$_POST['lat1']}' AND longitude = '{$_POST['lon1']}'");
